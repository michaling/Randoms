...
// ============ NAVIGATION BUTTONS ============
(function () {
    const pages = ['index.html', 'celebration.html', 'character.html', 'cat.html', 'date-settings.html', 'date-scene.html', 'game.html', 'maze.html', 'dance.html', 'save-the-date.html', 'dialogue.html'];
    const current = location.pathname.split('/').pop() || 'index.html';
